                ...
                <div class="row">
                    ...
                    <div class="col-xxl-4 col-md-6">
                        <div class="card info-card sales-card">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">Appointments <span>| Me</span></h5>
                    ...
                    <div class="col-xxl-4 col-md-6">
                        <div class="card info-card revenue-card">
                            ...
                            <div class="card-body">
                                <h5 class="card-title">Pending Bills <span>| Me</span></h5>
                    ...
                    <div class="col-xxl-4 col-xl-12">
                        ...
                        <div class="card info-card customers-card">
                            <div class="card-body">
                                <h5 class="card-title">Total Bills<span>| Me</span></h5>
                                    ...
                                    <ul class="nav nav-tabs nav-tabs-bordered d-flex" id="borderedTabJustified"
                                        ...
                                        <li class="nav-item flex-fill" role="presentation">
                                            <button class="nav-link w-100" id="profile-tab" data-bs-toggle="tab"
                                                ...
                                                aria-controls="profile" aria-selected="false">Appointment List</button>
                                        </li>
                                        <li class="nav-item flex-fill" role="presentation">
                                    ...
                                    <div class="tab-content pt-2" id="borderedTabJustifiedContent">
                                        ...
                                        <div class="tab-pane fade" id="bordered-justified-profile" role="tabpanel"
                                            ...
                                            <table class="table datatable">
                                                ...
                                                <tbody>
                                                    @foreach ($getAppointment as $item)
                                                        <tr>
                                                            ...
                                                            <td>
                                                                @if ($getApproved->where('request_id', $item->id)->count() > 0)
                                                                    {{ \Carbon\Carbon::parse($getApproved->where('request_id', $item->id)->first()->slotTime)->format('h:i A') }}
                                                                @else
                                                                    {{ '-' }}
                                                                @endif
                                                            </td>
            ...
            <div class="col-lg-4">
                <div class="card">
                    <div class="card-body">
                        ...
                        <a href="{{ url('_doctor/edit_patient/'.$getPatient->id) }}" class="btn btn-primary mb-1">Edit Profile
