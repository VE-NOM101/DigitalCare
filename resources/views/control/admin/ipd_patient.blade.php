                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if ($getInvoice->find($item->invoice_id)->status == 'unpaid')
                                            <a href="{{ url('_admin/edit_ipd_patient/' . $item->id) }}"
                                                class="btn btn-success"><i class="bi bi-pencil-square"></i></a>
                                        @endif
                                        <a href="{{ url('_admin/delete_ipd_patient/' . $item->id) }}"
                ...
                <div class="tab-pane fade" id="bordered-justified-contact" role="tabpanel" aria-labelledby="contact-tab">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <!-- Horizontal Form -->
                            <form action="{{ url('/_admin/add_ipd_patient') }}" method="POST">
                                @csrf
                                <div class="row mb-3">
                                ...
                                <div class="text-center">
                                    ...
                                    <a href="{{url('/_admin/ipd_patient')}}" class="btn btn-secondary">Cancel</a>
                                </div>
                            </form>
                            <!-- End Horizontal Form -->
