...
<aside id="sidebar" class="sidebar">
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link @if(Request::segment(2)=='users') @else collapsed @endif" href="{{url('/_admin/users')}}">
          <i class="bi bi-person"></i>
          <span>Users</span>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link @if(Request::segment(2)=='roles') @else collapsed @endif" href="{{url('/_admin/roles')}}">
