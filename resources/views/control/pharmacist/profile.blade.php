                    ...
                    <div class="card-body pt-3">
                        ...
                        <div class="tab-content pt-2">
                            ...
                            <div class="tab-pane fade show active profile-overview" id="profile-overview">
                                ...
                                <div class="row">
                                    <div class="col-lg-3 col-md-4 label ">Pharmacist ID: #{{ $getDetails->id }}</div>
                                </div>
                            ...
                            <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                ...
                                <!-- Profile Edit Form -->
                                <form action="{{ url('/_pharmacist/edit_profile/' . $getDetails->id) }}" method="POST">
                                    @csrf
                                    <div class="row mb-3">
                                    ...
                                    <div class="row mb-3">
                                        <label for="about" class="col-md-4 col-lg-3 col-form-label">Qualification</label>
                                        <div class="col-md-8 col-lg-9">
                            ...
                            {{-- <div class="tab-pane fade pt-3" id="profile-change-password">
                                ...
                                <form action="{{ url('/_nurse/change_password/' . $getDetails->user_id) }}" method="POST">
                                    @csrf
                                    <div class="row mb-3">
